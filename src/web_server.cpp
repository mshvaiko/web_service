...
namespace server
{
    ...
    void web_server::run()
    {
        ...
        std::string resp = "<html><body><center><h1>Hello World!</h1></center></body></html>";
        ...
        while (true)
        {
            ...
            auto client_fd = accept(sock_fd, reinterpret_cast<sockaddr*>(&client), &client_len);
            std::cout << "Client with" << inet_ntoa(client.sin_addr) << " connected" << std::endl;
